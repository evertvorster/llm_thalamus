...
class ControllerWorker(QObject):
    ...
    def __init__(self, cfg):
        ...
        self._runtime_services = build_runtime_services(
            ...
            prefill_shared_memory_k=int(getattr(self._cfg, "orchestrator_prefill_shared_k", 2) or 2),
            prefill_user_memory_k=int(getattr(self._cfg, "orchestrator_prefill_user_k", 2) or 2),
            prefill_agent_memory_k=int(getattr(self._cfg, "orchestrator_prefill_agent_k", 2) or 2),
