...
def test_default_graph_path_uses_primary_agent_then_mechanical_memory_reflect() -> None:
    ...
    assert "reflect_topics" not in node_ids
    ...
    assert ("primary_agent", "reflect_memory", False) in edges
