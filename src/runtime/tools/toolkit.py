...
def _load_skills() -> dict[str, Skill]:
    skills: list[Skill] = [
        ...
        Skill(name=mcp_mempalace_full.SKILL_NAME, selectors=tuple(mcp_mempalace_full.TOOL_SELECTORS)),
        Skill(name=mcp_mempalace_write.SKILL_NAME, selectors=tuple(mcp_mempalace_write.TOOL_SELECTORS)),
