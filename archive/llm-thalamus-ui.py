...
- Hooks for future thalamus event integration (chat, status, control entries)
"""
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_thalamus_dock(self):
        ...
        self.addDockWidget(QtCore.Qt.BottomDockWidgetArea, self.thalamus_dock)
    ...
    def _set_thalamus_status(self, status: str):
        ...
        # Enable send only when thalamus is connected (not implemented yet)
    ...
    def _on_send_clicked(self):
        ...
        # This method is kept as a hook for when thalamus is ready.
